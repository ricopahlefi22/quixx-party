<x-app>
    <x-card.card>
        <div class="p-3 flex items-center justify-between">
            <h2 class="text-base font-semibold text-slate-600">Data TPS</h2>
            <x-button.btn url="#" class="primary"  label="Tambah TPS" />
        </div>
        <div class="p-3">
            <div>
                <x-table.table>
                    ...
                    @foreach($list_voting_place as $item)
                    <tr>
                        ...
                        <x-table.td-action x-data="modal">
                            ...
                            <td>{{ucwords($item->village->name)}}</td>
