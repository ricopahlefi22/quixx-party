            ...
            <?php
                ...
                <div class="grid lg:grid-cols-2 grid-cols-1 gap-6">
                    <div class="card">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse"
                                        data-fc-target="DefualOffcanvasHtml">
                        ...
                        <div class="p-6">
                            <button class="bg-primary text-white hover:bg-primary-600 py-2 px-4 rounded transition-all"
                                data-fc-target="default-offcanvas" data-fc-type="offcanvas">
                                Open Offcanvas
                            </button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse"
                                        data-fc-target="AutoTargetOffcanvasHtml">
                                        <i class="mgc_eye_line text-lg"></i>
                                        <span class="ms-2">Code</span>
                                    </button>
                        ...
                        <div class="p-6">
                            ...
                            <div id="AutoTargetOffcanvasHtml"
                                class="hidden w-full overflow-hidden transition-[height] duration-300">
                                <pre class="language-html h-56">
                                    <code>
                                        &lt;button class=&quot;bg-primary text-white hover:bg-primary-600 py-2 px-4 rounded transition-all&quot; data-fc-type=&quot;offcanvas&quot;&gt;
