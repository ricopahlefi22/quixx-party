                    ...
                    <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
                        <div class="card">
                            ...
                            <div class="flex flex-col">
                                <div class="py-3 px-6">
                                    <h5 class="my-2"><a href="#" class="text-slate-900 dark:text-slate-200">Landing page Design</a></h5>
                        ...
                        <div class="card">
                            ...
                            <div class="flex flex-col">
                                <div class="py-3 px-6">
                                    <h5 class="my-2"><a href="#" class="text-slate-900 dark:text-slate-200">App Design and Develop</a></h5>
                                    <p class="text-gray-500 text-sm mb-9">To achieve this, it would be necessary to have uniform grammar and more common words.</p>

                                    <div class="flex -space-x-2">
                                        <a href="javascript: void(0);">
                                            <img class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-700" src="assets/images/users/avatar-4.jpg" alt="Image Description">
                                        </a>
                                        <a href="javascript: void(0);">
                                            <img class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-700" src="assets/images/users/avatar-5.jpg" alt="Image Description">
                                        </a>
                                        <a href="javascript: void(0);">
                                            <img class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-700" src="assets/images/users/avatar-6.jpg" alt="Image Description">
                                        </a>
                                        <a href="javascript: void(0);">
                                            <img class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-700" src="assets/images/users/avatar-7.jpg" alt="Image Description">
                                        </a>
                                        <a href="javascript: void(0);">
                                            <div class="relative inline-flex">
                        ...
                        <div class="card">
                            ...
                            <div class="flex flex-col">
                                <div class="py-3 px-6">
                                    <h5 class="my-2"><a href="#" class="text-slate-900 dark:text-slate-200">New Admin Design</a></h5>
                                    <p class="text-gray-500 text-sm mb-9">If several languages coalesce, the grammar of the resulting language is more regular.</p>

                                    <div class="flex -space-x-2">
                                        <a href="javascript: void(0);">
                                            <img class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-700" src="assets/images/users/avatar-9.jpg" alt="Image Description">
                                        </a>
                                        <a href="javascript: void(0);">
                                            <img class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-700" src="assets/images/users/avatar-10.jpg" alt="Image Description">
                                        </a>
                                        <a href="javascript: void(0);">
                                            <img class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-700" src="assets/images/users/avatar-1.jpg" alt="Image Description">
                                        </a>
                                        <a href="javascript: void(0);">
                                            <div class="relative inline-flex">
                                                <button id="" class="inline-flex items-center justify-center h-12 w-12 rounded-full bg-gray-200 border-2 border-white font-medium text-gray-700 shadow-sm align-middle dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 transition-all text-sm">
                        ...
                        <div class="card">
                            ...
                            <div class="flex flex-col">
                                <div class="py-3 px-6">
                                    <h5 class="my-2"><a href="#" class="text-slate-900 dark:text-slate-200">Custom Software Development</a></h5>
                                    ...
                                    <div class="flex -space-x-2">
                                        ...
                                        <a href="javascript: void(0);">
                                            <img class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-700" src="assets/images/users/avatar-8.jpg" alt="Image Description">
                                        </a>
                                        <a href="javascript: void(0);">
                                            <img class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-700" src="assets/images/users/avatar-9.jpg" alt="Image Description">
                                        </a>
                        ...
                        <div class="card">
                            ...
                            <div class="flex flex-col">
                                <div class="py-3 px-6">
                                    <h5 class="my-2"><a href="#" class="text-slate-900 dark:text-slate-200">Brand logo design</a></h5>
                        ...
                        <div class="card">
                            ...
                            <div class="flex flex-col">
                                <div class="py-3 px-6">
                                    <h5 class="my-2"><a href="#" class="text-slate-900 dark:text-slate-200">Website Redesign</a></h5>
