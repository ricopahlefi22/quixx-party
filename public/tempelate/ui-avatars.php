                        ...
                        <div class="p-6">
                            <div class="flex flex-wrap items-end gap-3">
                                ...
                                <div class="h-16 w-16 relative inline-flex">
                                    ...
                                    <div class="absolute end-0 m-1 h-2.5 w-2.5 rounded-full border border-white bg-success">
                                    </div>
                                </div>
                                <div class="h-20 w-20 relative inline-flex">
                                    <img src="assets/images/users/avatar-4.jpg" alt="image" class="rounded-full">
                                    <div class="absolute end-0 m-1.5 h-2.5 w-2.5 rounded-full border border-white bg-success">
                                    </div>
                                </div>
                                ...
                                <div class="h-28 w-28 relative inline-flex">
                                    ...
                                    <div class="absolute end-0 m-1.5 h-4 w-4 rounded-full border-2 border-white bg-success">
                                    </div>
                                </div>
                                <div class="relative h-32 w-32 inline-flex">
                                    <img src="assets/images/users/avatar-7.jpg" alt="image" class="rounded-full">
                                    <div class="absolute end-0 m-2  h-5 w-5 rounded-full border-[3px] border-white bg-success">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap items-end gap-3">
                                <div class="flex-shrink-0 group block">
                                    <div class="flex items-center">
                                        <img class="inline-block flex-shrink-0 h-16 w-16 rounded-full" src="assets/images/users/avatar-5.jpg" alt="Image Description">
                                        <div class="ms-3">
                    ...
                    <div class="card">
                        ...
                        <div class="p-6">
                            <div class="flex-col space-y-2">
                                <div class="flex">
                                    <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800" src="assets/images/users/avatar-1.jpg" alt="Image Description">
                                    <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800" src="assets/images/users/avatar-2.jpg" alt="Image Description">
                                    <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800" src="assets/images/users/avatar-3.jpg" alt="Image Description">
                                    <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800" src="assets/images/users/avatar-4.jpg" alt="Image Description">
                                </div>
                                <div class="flex">
                                    <img class="inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-gray-800" src="assets/images/users/avatar-1.jpg" alt="Image Description">
                                    <img class="inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-gray-800" src="assets/images/users/avatar-2.jpg" alt="Image Description">
                                    <img class="inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-gray-800" src="assets/images/users/avatar-3.jpg" alt="Image Description">
                                    <img class="inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-gray-800" src="assets/images/users/avatar-4.jpg" alt="Image Description">
                                </div>
                                <div class="flex">
                                ...
                                <div class="flex">
                                    <img class="inline-block h-16 w-16 rounded-full ring-2 ring-white dark:ring-gray-800" src="assets/images/users/avatar-1.jpg" alt="Image Description">
                                    <img class="inline-block h-16 w-16 rounded-full ring-2 ring-white dark:ring-gray-800" src="assets/images/users/avatar-2.jpg" alt="Image Description">
                                    <img class="inline-block h-16 w-16 rounded-full ring-2 ring-white dark:ring-gray-800" src="assets/images/users/avatar-3.jpg" alt="Image Description">
                                    <img class="inline-block h-16 w-16 rounded-full ring-2 ring-white dark:ring-gray-800" src="assets/images/users/avatar-4.jpg" alt="Image Description">
                                </div>
                            </div>
