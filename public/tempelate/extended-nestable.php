...
<body>
            ...
            <main class="flex-grow p-6">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="card">
                        ...
                        <div class="p-6">
                            <p class="text-gray-400 mb-4">Try sorting the list on the left. It is not possible because it has it's <code>sort</code> option set to false. However, you can still drag from the list on the left to the list on the right.</p>
                            <div class="grid md:grid-cols-2 gap-5">
                    ...
                    <div class="card">
                        ...
                        <div class="p-6">
                            <p class="text-gray-400 mb-4">Try dragging the item with a red background. It cannot be done, because that item is filtered out using the <code>filter</code> option.</p>
                    ...
                    <div class="card">
                        ...
                        <div class="p-6">
                            <p class="text-gray-400 mb-4">The <a target="_blank" href="https://github.com/SortableJS/Sortable/tree/master/plugins/MultiDrag">MultiDrag</a> plugin allows for multiple items to be dragged at a time. You can click to "select" multiple items, and then drag them as one item.</p>
                    ...
                    <div class="card">
                        ...
                        <div class="p-6">
                            <p class="text-gray-400 mb-4">The <a target="_blank" href="https://github.com/SortableJS/Sortable/tree/master/plugins/Swap">Swap</a> plugin changes the behaviour of Sortable to allow for items to be swapped with eachother rather than sorted.</p>
    ...
    <script src="assets/js/pages/extended-sortable.js"></script>
