                            ...
                            <div class="p-6">
                                <div>
                                    ...
                                    <div class="grid grid-cols-4 gap-6">
                                        <div class="">
                                            <div class="">
                                                <p class="mb-3 text-sm uppercase font-medium"><i class="uil-calender text-red-500 text-base"></i> Start Date</p>
                                                <h5 class="text-base text-gray-700 dark:text-gray-300 font-medium">15 July, 2019</h5>
                                            </div>
                                        </div>
                                        <div class="">
                                            <p class="mb-3 text-sm uppercase font-medium"><i class="uil-calendar-slash text-red-500 text-base"></i> Due Date</p>
                                            <h5 class="text-base text-gray-700 dark:text-gray-300 font-medium">21 Nov, 2020</h5>
                                        </div>
                                        <div class="">
                                            <p class="mb-3 text-sm uppercase font-medium"><i class="uil-dollar-alt text-red-500 text-base"></i> Budget</p>
                                            <h5 class="text-base text-gray-700 dark:text-gray-300 font-medium">$13,250</h5>
                                        </div>

                                        <div class="">
                                            <p class="mb-3 text-sm uppercase font-medium"><i class="uil-user text-red-500 text-base"></i> Owner</p>
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <div class="flex flex-wrap -space-x-2">
                                            <a href="javascript: void(0);">
                                                <img class="inline-block h-10 w-10 rounded-full border-2 border-white dark:border-gray-800" src="assets/images/users/avatar-2.jpg" alt="Image Description">
                                            </a>
                                            <a href="javascript: void(0);">
                                                <img class="inline-block h-10 w-10 rounded-full border-2 border-white dark:border-gray-800" src="assets/images/users/avatar-3.jpg" alt="Image Description">
                                            </a>
                                            <a href="javascript: void(0);">
                                                <img class="inline-block h-10 w-10 rounded-full border-2 border-white dark:border-gray-800" src="assets/images/users/avatar-9.jpg" alt="Image Description">
                                            </a>
                                            <a href="javascript: void(0);">
                                                <img class="inline-block h-10 w-10 rounded-full border-2 border-white dark:border-gray-800" src="assets/images/users/avatar-10.jpg" alt="Image Description">
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="grid md:grid-cols-4 gap-3">
                                            <div class="p-2 border border-gray-200 dark:border-gray-700 rounded mb-2">
                                                <div class="flex items-center">
                                                    ...
                                                    <div>
                                                        <a href="#" class="p-2"><i class="mgc_download_line text-xl"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="divide-y divide-gray-300 dark:divide-gray-700 overflow-auto w-full max-w-full">
                                    <div class="p-3">
                                        <div class="flex items-center gap-3">
                                            <div class="h-10 w-10 flex-shrink-0">
                                                <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-1.jpg" alt="">
                                            </div>
                                    ...
                                    <div class="p-3">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="ms-auto">
                                                <div class=" px-3 py-1 rounded text-xs font-medium bg-success/25 text-success">Complated</div>
                                            </div>
                                        </div>
                                    </div>
