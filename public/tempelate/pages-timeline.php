                            ...
                            <div class="md:col-start-2 col-span-2">
                                <div class="relative md:ms-10 ms-20">
                                    <div class="card p-5">
                                        ...
                                        <p class="mb-2 text-gray-500 dark:text-gray-200"><small>08:25 am</small></p>
                                        <p class="text-gray-500 dark:text-gray-200">Dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? </p>
                                    </div>
                            ...
                            <div class="md:col-span-1 col-span-2">
                                <div class="relative md:me-10 md:ms-0 ms-20">
                                    <div class="card p-5">
                                        ...
                                        <p class="mb-2 text-gray-500 dark:text-gray-200"><small>08:25 am</small></p>
                                        <p class="text-gray-500 dark:text-gray-200">consectetur adipisicing elit. Iusto, optio, dolorum <a href="#">John deon</a> provident rerum aut hic quasi placeat iure tempora laudantium </p>
                                    </div>
                                    ...
                                    <div class="card p-5">
                                        ...
                                        <div class="flex gap-2 mt-4">
                                            <a href="javascript: void(0);">
                                                <img class="rounded w-14" alt="" src="assets/images/small/img-1.jpg">
                                            </a>
                                            <a href="javascript: void(0);">
                                                <img class="rounded w-14" alt="" src="assets/images/small/img-2.jpg">
                                            </a>
                                            <a href="javascript: void(0);">
                                                <img class="rounded w-14" alt="" src="assets/images/small/img-3.jpg">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="bg-white dark:bg-gray-800 absolute h-4 w-4 rotate-45 rounded-sm top-7 -start-2"></div>
                            ...
                            <div class="md:col-start-2 col-span-2">
                                <div class="relative md:ms-10 ms-20">
                                    <div class="card p-5">
                                        ...
                                        <p class="mb-2 text-gray-500 dark:text-gray-200"><small>08:25 am</small></p>
                                        <p class="text-gray-500 dark:text-gray-200">Jonatha Smith added new milestone <span><a href="#">Pathek</a></span>
                            ...
                            <div class="md:col-span-1 col-span-2">
                                <div class="relative md:me-10 md:ms-0 ms-20">
                                    <div class="card p-5">
                                        <h4 class="mb-2 text-base">07 January 2018</h4>
                                        <p class="mb-2 text-gray-500 dark:text-gray-200"><small>08:25 am</small></p>
                                        <p class="text-gray-500 dark:text-gray-200">Jonatha Smith added new milestone <span><a class="blue" href="#">crishtian</a></span>
                                            Lorem ipsum dolor sit amet consiquest dio</p>
                                    </div>
                                    <div class="bg-white dark:bg-gray-800 absolute h-4 w-4 rotate-45 rounded-sm top-7 md:-end-2 md:start-auto -start-2"></div>
                                </div>
                            ...
                            <div class="md:col-span-1 col-span-2">
                                <div class="relative md:me-10 md:ms-0 ms-20">
                                    <div class="card p-5">
                                        ...
                                        <p class="mb-2 text-gray-500 dark:text-gray-200"><small>08:25 am</small></p>
                                        <p class="text-gray-500 dark:text-gray-200">Jonatha Smith added new milestone <span><a href="#">prank</a></span>
                                            Lorem ipsum dolor sit amet consiquest dio</p>
                                    </div>
                                    <div class="bg-white dark:bg-gray-800 absolute h-4 w-4 rotate-45 rounded-sm top-7 md:-end-2 md:start-auto -start-2"></div>
                                </div>
