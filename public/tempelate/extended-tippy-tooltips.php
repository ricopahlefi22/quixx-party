...
<head>
    <?php $title = "Tippy Tooltips";
    include 'partials/title-meta.php'; ?>

    <link href="assets/libs/tippy.js/tippy.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <!-- Tippy Demo js-->
    <script src="assets/js/pages/extended-tippy.js"></script>
