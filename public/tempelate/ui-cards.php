        ...
        <div class="page-content">
            ...
            <main class="flex-grow p-6">
                ...
                <div class="grid lg:grid-cols-4 gap-6">
                    <div>
                        <div class="card">
                            <img class="w-full h-auto rounded-t-xl" src="assets/images/small/small-1.jpg" alt="Image Description">
                            <div class="p-6">
                    ...
                    <div>
                        <div class="card">
                            <img class="w-full h-auto rounded-t-xl" src="assets/images/small/small-2.jpg" alt="Image Description">
                            <div class="p-6">
                                <h3 class="text-lg font-bold text-gray-800 dark:text-white">
                                    Card title
                                </h3>
                    ...
                    <div>
                        <div class="relative bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                            <img class="w-full h-auto rounded-xl" src="assets/images/small/img-7.jpg" alt="Image Description">
