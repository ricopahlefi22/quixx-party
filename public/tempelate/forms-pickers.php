...
<body>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse" data-fc-target="HumanFriendlyPickerHtml">
                                        <i class="mgc_eye_line text-lg"></i>
                                        <span class="ms-2">Code</span>
                                    </button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse" data-fc-target="DisablingPickerHtml">
                                        <i class="mgc_eye_line text-lg"></i>
                                        <span class="ms-2">Code</span>
                                    </button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse" data-fc-target="MultipalPickerHtml">
                                        <i class="mgc_eye_line text-lg"></i>
                                        <span class="ms-2">Code</span>
                                    </button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse" data-fc-target="RangePickerHtml">
                                        <i class="mgc_eye_line text-lg"></i>
                                        <span class="ms-2">Code</span>
                                    </button>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" class="btn-code" data-fc-type="collapse" data-fc-target="ColorPickerHtml">
                                            <i class="mgc_eye_line text-lg"></i>
                                            <span class="ms-2">Code</span>
                                        </button>
    ...
    <!-- init js -->
    <script src="assets/js/pages/form-flatpickr.js"></script>

    <!-- init js -->
    <script src="assets/js/pages/form-color-pickr.js"></script>
