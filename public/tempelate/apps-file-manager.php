                                                        ...
                                                        <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
                                                            <tr>
                                                                ...
                                                                <td class="p-3.5">
                                                                    <div class="flex -space-x-1.5">
                                                                        <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-gray-700" src="assets/images/users/avatar-1.jpg" alt="Image Description">
                                                                        <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-gray-700" src="assets/images/users/avatar-2.jpg" alt="Image Description">
                                                                        <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-gray-700" src="assets/images/users/avatar-3.jpg" alt="Image Description">
                                                                        <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-gray-700" src="assets/images/users/avatar-4.jpg" alt="Image Description">
                                                                    </div>
                                                                </td>
                                                                <td class="p-3.5">
                                                                    <div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="p-3.5">
                                                                    <div class="flex -space-x-1.5">
                                                                        <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-gray-700" src="assets/images/users/avatar-4.jpg" alt="Image Description">
                                                                        <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-gray-700" src="assets/images/users/avatar-8.jpg" alt="Image Description">
                                                                        <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-gray-700" src="assets/images/users/avatar-6.jpg" alt="Image Description">
                                                                    </div>
                                                                </td>
                                                                <td class="p-3.5">
                                                                    <div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="p-3.5">
                                                                    <div class="flex -space-x-1.5">
                                                                        <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-gray-700" src="assets/images/users/avatar-5.jpg" alt="Image Description">
                                                                        <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-gray-700" src="assets/images/users/avatar-7.jpg" alt="Image Description">
                                                                        <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white dark:ring-gray-700" src="assets/images/users/avatar-4.jpg" alt="Image Description">
                                                                    </div>
                                                                </td>
                                                                <td class="p-3.5">
