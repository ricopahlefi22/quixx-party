                        ...
                        <div class="relative overflow-x-auto">
                            <table class="w-full divide-y divide-gray-300 dark:divide-gray-700">
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700 ">
                                    <tr>
                                        <td class="whitespace-nowrap py-4 ps-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200"><b>#1020</b></td>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 ps-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200"><b>#1254</b></td>
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0">
                                                    <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-2.jpg" alt="">
                                                </div>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 ps-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200"><b>#1256</b></td>
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0">
                                                    <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-3.jpg" alt="user">
                                                </div>
                                                <div class="font-medium text-gray-900 dark:text-gray-200 ms-4">Jerry Geiger</div>
                                            </div>
                                        </td>
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200"> Support for theme</td>
                                        <td class="whitespace-nowrap py-4 px-3 text-sm">
                                            <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-3.jpg" alt="">
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 ps-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200"><b>#1352</b></td>
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0">
                                                    <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-4.jpg" alt="user">
                                                </div>
                                        ...
                                        <td class="whitespace-nowrap py-4 px-3 text-sm">
                                            <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-4.jpg" alt="">
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <div class="inline-flex items-center gap-1.5 py-1 px-3 rounded text-xs font-medium bg-danger/25 text-danger">High</div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 ps-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200"><b>#2251</b></td>
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0">
                                                    <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-5.jpg" alt="user">
                                                </div>
                                        ...
                                        <td class="whitespace-nowrap py-4 px-3 text-sm">
                                            <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-5.jpg" alt="">
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <div class="inline-flex items-center gap-1.5 py-1 px-3 rounded text-xs font-medium bg-danger/25 text-danger">High</div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 ps-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200"><b>#2542</b></td>
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0">
                                                    <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-6.jpg" alt="user">
                                                </div>
                                        ...
                                        <td class="whitespace-nowrap py-4 px-3 text-sm">
                                            <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-6.jpg" alt="">
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <div class="inline-flex items-center gap-1.5 py-1 px-3 rounded text-xs font-medium bg-primary/25 text-primary">Medium</div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 ps-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200"><b>#3020</b></td>
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0">
                                                    <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-7.jpg" alt="user">
                                                </div>
                                        ...
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200">Verify your new email address!</td>
                                        <td class="whitespace-nowrap py-4 px-3 text-sm">
                                            <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-7.jpg" alt="">
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <div class="inline-flex items-center gap-1.5 py-1 px-3 rounded text-xs font-medium bg-danger/25 text-danger">High</div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 ps-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200"><b>#3562</b></td>
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0">
                                                    <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-8.jpg" alt="user">
                                                </div>
                                        ...
                                        <td class="whitespace-nowrap py-4 px-3 text-sm">
                                            <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-8.jpg" alt="">
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <div class="inline-flex items-center gap-1.5 py-1 px-3 rounded text-xs font-medium bg-dark/25 text-slate-900 dark:text-slate-200/90">Low</div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 ps-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200"><b>#3652</b></td>
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0">
                                                    <img class="h-10 w-10 rounded-full" src="assets/images/users/avatar-9.jpg" alt="user">
                                                </div>
                                                <div class="ms-4">
