                ...
                <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
                    <div class="card">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse"
                                        data-fc-target="defaultBadgeHtml">
                        ...
                        <div class="p-6">
                            <div class="flex flex-wrap items-end gap-2">
                                ...
                                <span
                                    class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-white text-gray-600">Badge</span>
                            </div>

                            <div id="defaultBadgeHtml"
                    ...
                    <div class="card">
                        ...
                        <div class="p-6">
                            <div class="flex flex-wrap items-end gap-2">
                                <span
                                    class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-gray-100 text-gray-800">Badge</span>
                                <span
                                ...
                                <span
                                    class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-white/[.1] text-gray-600 dark:text-gray-400">Badge</span>
                            </div>
                            <div id="SoftBadgesHtml"
                                class="hidden w-full overflow-hidden transition-[height] duration-300">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse"
                                        data-fc-target="RoundedBadgesHtml">
                                        <i class="mgc_eye_line text-lg"></i>
                                        <span class="ms-2">Code</span>
                                    </button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse"
                                        data-fc-target="IndicatorBadgesHtml">
                                        <i class="mgc_eye_line text-lg"></i>
                                        <span class="ms-2">Code</span>
                                    </button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse"
                                        data-fc-target="CloseIndicatorBadgesHtml">
                                        <i class="mgc_eye_line text-lg"></i>
                                        <span class="ms-2">Code</span>
                                    </button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse"
                                        data-fc-target="max_width_BadgesHtml">
                                        <i class="mgc_eye_line text-lg"></i>
                                        <span class="ms-2">Code</span>
                                    </button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse"
                                        data-fc-target="Button_BadgesHtml">
                                        <i class="mgc_eye_line text-lg"></i>
                                        <span class="ms-2">Code</span>
                                    </button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <button type="button" class="btn-code" data-fc-type="collapse"
                                        data-fc-target="Posinited_BadgesHtml">
                                        <i class="mgc_eye_line text-lg"></i>
                                        <span class="ms-2">Code</span>
                                    </button>
