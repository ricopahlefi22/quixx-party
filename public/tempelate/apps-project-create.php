                ...
                <div class="grid lg:grid-cols-4 gap-6">
                    <div class="col-span-1 flex flex-col gap-6">
                        <div class="card p-6">
                            ...
                            <form action="#" class="dropzone flex items-center justify-center text-gray-700 dark:text-gray-300 h-52">
                                <div class="fallback">
                            ...
                            <div class="flex flex-col gap-3">
                                ...
                                <div class="flex gap-3">
                                    <div class="flex -space-x-2">
                                        <img class="inline-block h-8 w-8 rounded-full ring-2 ring-gray-200 dark:ring-gray-700" src="assets/images/users/user-9.jpg" alt="Image Description">
                                        <img class="inline-block h-8 w-8 rounded-full ring-2 ring-gray-200 dark:ring-gray-700" src="assets/images/users/user-8.jpg" alt="Image Description">
                                        <img class="inline-block h-8 w-8 rounded-full ring-2 ring-gray-200 dark:ring-gray-700" src="assets/images/users/user-7.jpg" alt="Image Description">
                                        <img class="inline-block h-8 w-8 rounded-full ring-2 ring-gray-200 dark:ring-gray-700" src="assets/images/users/user-6.jpg" alt="Image Description">
                                    </div>
                                </div>
                            </div>
                        </div>
