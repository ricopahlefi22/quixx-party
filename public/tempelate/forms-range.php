...
<body>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" class="btn-code" data-fc-type="collapse" data-fc-target="UsingInputRangeHtml">
                                            <i class="mgc_eye_line text-lg"></i>
                                            <span class="ms-2">Code</span>
                                        </button>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" class="btn-code" data-fc-type="collapse" data-fc-target="ShowingRangeHtml">
                                            <i class="mgc_eye_line text-lg"></i>
                                            <span class="ms-2">Code</span>
                                        </button>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" class="btn-code" data-fc-type="collapse" data-fc-target="ColoredConnectRangeHtml">
                                            <i class="mgc_eye_line text-lg"></i>
                                            <span class="ms-2">Code</span>
                                        </button>
                            ...
                            <div class="p-6">
                                ...
                                <div id="ColoredConnectRangeHtml" class="hidden w-full overflow-hidden transition-[height] duration-300">
                                    <pre class="language-html h-auto">
                                        <code>
                                            &lt;div class=&quot;slider&quot; id=&quot;slider-color&quot;&gt;&lt;/div&gt;
                                        </code>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" class="btn-code" data-fc-type="collapse" data-fc-target="ColorRangeHtml">
                                            <i class="mgc_eye_line text-lg"></i>
                                            <span class="ms-2">Code</span>
                                        </button>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" class="btn-code" data-fc-type="collapse" data-fc-target="NonLinerRangeHtml">
                                            <i class="mgc_eye_line text-lg"></i>
                                            <span class="ms-2">Code</span>
                                        </button>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" class="btn-code" data-fc-type="collapse" data-fc-target="CreatToggleRangeHtml">
                                            <i class="mgc_eye_line text-lg"></i>
                                            <span class="ms-2">Code</span>
                                        </button>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" class="btn-code" data-fc-type="collapse" data-fc-target="SoftLimiteRangeHtml">
                                            <i class="mgc_eye_line text-lg"></i>
                                            <span class="ms-2">Code</span>
                                        </button>
    ...
    <script src="assets/js/pages/form-rangeslider.js"></script>
